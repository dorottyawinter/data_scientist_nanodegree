...
class Binomial(Distribution):
    ...
    def plot_pdf(self):
        ...
        plt.bar(x=k_list, height=pdf_list)
        plt.title('Probability density function plot') 
        plt.xlabel('outcome')
        plt.ylabel('probability')
        plt.show()

        return k_list, pdf_list
    ...
    def __repr__(self):
        ...
        """
        #return 'mean {}, standard deviation {}, p {}, n {}'.format(round(self.mean, 1), round(self.stdev, 1), round(self.p, 1), self.n)
